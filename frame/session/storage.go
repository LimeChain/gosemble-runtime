...
func newStorage(s io.Storage, m Module) *storage {
	...
	return &storage{
		...
		NextKeys:           support.NewHashStorageMap[primitives.AccountId, sc.FixedSequence[primitives.Sr25519PublicKey]](s, keySession, keyNextKeys, hashing.Twox64, m.DecodeKeys),
