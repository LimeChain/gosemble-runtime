...
func Test_Session_PurgeKeys_Success(t *testing.T) {
	...
	assertSessionEmptyStorage(t, storage, signature.TestKeyringPairAlice.PublicKey, key.ToBytes(), aura.KeyTypeId)
...
func Test_Session_PurgeKeys_NoPreviousKeys(t *testing.T) {
	...
	assert.Equal(t, applyExtrinsicResultSessionNoKeysErr.Bytes(), res)
}
